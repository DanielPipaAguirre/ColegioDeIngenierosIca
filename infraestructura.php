...
<?php require 'header/title.php';
    ...
    <section class="caja">
        ...
        <nav class="menu1">
            ...
            <ul>    
                ...
                <li class="so-lazer1" id="local-countryside"><a>Local Campestre</a></li>
                <li class="so-dependencias1" id="sports-slab"><a>Losa Deportiva</a></li>
                <li class="so-salas1" id="swimming-pool"><a>Piscina</a></li>
            </ul>
        </nav>
    </section>
    <section class="image-gallery"> 
        <ul class="galeria">
                ...
                <li class="galeria__item lazer">
                    <img src="public/img/infraestructura/2.jpg" class="galeria__img">
                </li>
                <li class="galeria__item lazer">
                ...
                <li class="galeria__item salas">
                    <img src="public/img/infraestructura/9.jpg" class="galeria__img">
                </li>
                <li class="galeria__item lazer1">
                ...
                <li class="galeria__item dependencias1">
                    <img src="public/img/infraestructura/16.jpg" class="galeria__img">
                </li>
                <li class="galeria__item dependencias1">
                    <img src="public/img/infraestructura/17.jpg" class="galeria__img">
                </li>
                <li class="galeria__item dependencias1">
                    <img src="public/img/infraestructura/18.jpg" class="galeria__img">
                </li>
            </ul>
